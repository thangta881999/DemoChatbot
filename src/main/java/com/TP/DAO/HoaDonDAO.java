...
//		
	...
	public Map<String, BigInteger> getProductSellbyCat() {
		...
		String query="SELECT t.tendanhmuc,count(t.soluong) as soluong FROM\n" + 
				" (SELECT sp.madanhmuc,dm.tendanhmuc , cthd.soluong FROM  ( ( (heroku_7bc1307ac1f5a85.chitiethoadon  cthd inner join heroku_7bc1307ac1f5a85.hoadon hd)   inner join heroku_7bc1307ac1f5a85.chitietsanpham ctsp  )\n" +
				"															inner join heroku_7bc1307ac1f5a85.sanpham sp  )  inner join heroku_7bc1307ac1f5a85.danhmucsanpham dm\n" +
	...
	public boolean CheckBillUserDelivered(int masanpham,String tenkhachhang) {
		...
		Session session = sessionFactory.getCurrentSession();
		String query= " SELECT hd.tenkhachhang FROM  heroku_7bc1307ac1f5a85.chitiethoadon  cthd inner join heroku_7bc1307ac1f5a85.hoadon hd inner join chitietsanpham ctsp " +
