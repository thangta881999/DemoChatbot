...
//		
	...
	public Map<String, BigInteger> getProductSellbyCat() {
		...
		String query="SELECT t.tendanhmuc,count(t.soluong) as soluong FROM\n" + 
				" (SELECT sp.madanhmuc,dm.tendanhmuc , cthd.soluong FROM  ( ( (heroku_2af2ba3295e5ef2.chitiethoadon  cthd inner join heroku_2af2ba3295e5ef2.hoadon hd)   inner join heroku_2af2ba3295e5ef2.chitietsanpham ctsp  )\n" + 
				"															inner join heroku_2af2ba3295e5ef2.sanpham sp  )  inner join heroku_2af2ba3295e5ef2.danhmucsanpham dm\n" + 
	...
	public boolean CheckBillUserDelivered(int masanpham,String tenkhachhang) {
		...
		Session session = sessionFactory.getCurrentSession();
		String query= " SELECT hd.tenkhachhang FROM  heroku_2af2ba3295e5ef2.chitiethoadon  cthd inner join heroku_2af2ba3295e5ef2.hoadon hd inner join chitietsanpham ctsp " +
